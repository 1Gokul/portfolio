...
const BackToTop = () => {
  ...
  return (
    <Box as="button" onClick={sendToTop} marginLeft="auto">{buttonText}&#8593;</Box>
  )
...
const Footer = () => {
  return (
    <Grid templateColumns={{ base: "1fr .5fr", md: "1fr 1fr 1fr" }}
      width="100%"
      justifyItems="center"
      marginTop={10}
      marginBottom={3}
    ...
    >
      ...
      <Box gridColumnStart={{ base: 1, md: 2 }}
        color="gray.400"
      >
        <Link href="https://github.com/1Gokul/portfolio">
          <Text align="center">
          By Gokul Viswanath
            <br />Built with Gatsby
          </Text>
        </Link>
      </Box>
