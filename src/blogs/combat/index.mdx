...
<GatsbyImage alt="OneHandedAttack2_AnimNotifies.jpg" image={getImage(props.localImages[1])} />
...
<iframe src="https://www.youtube.com/embed/9-j5ZczCl1M" width="100%" height="300px" frameborder="0"> </iframe> 

- While Unarmed and in Combat Mode
<iframe src="https://www.youtube.com/embed/Hxo1z0V2Xec" width="100%" height="300px" frameborder="0"> </iframe> 