...
<GatsbyImage alt="TimedSheathe.jpg" image={getImage(props.localImages[1])} />
...
<GatsbyImage alt="TimedDraw.jpg" image={getImage(props.localImages[0])} />
...
- One-Handed Weapon
<iframe src="https://www.youtube.com/embed/U46rnurwsqs" width="100%" height="300px" frameborder="0"> </iframe> 

- Two-Handed Weapon
<iframe src="https://www.youtube.com/embed/Yf2b-jehppk" width="100%" height="300px" frameborder="0"> </iframe> 
