...
After some digging, I set up SQLAlchemy on my app with its 
[Flask extension](https://flask-sqlalchemy.palletsprojects.com/en/2.x/) and setup a
Postgres DB on [Heroku](https://www.heroku.com/postgres).
...
<GatsbyImage alt="actor-detail.jpg" image={getImage(props.localImages[1])} />
