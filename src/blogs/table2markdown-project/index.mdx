...
<GatsbyImage alt="result_md_table" image={getImage(props.localImages[5])} />
...
<GatsbyImage alt="keyguides.png" image={getImage(props.localImages[4])} />
...
<GatsbyImage alt="keyguides_changing.gif" image={getImage(props.localImages[3])} />
