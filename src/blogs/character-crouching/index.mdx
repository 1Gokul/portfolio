...
<GatsbyImage alt="CrouchedLayeredBlendPerBone" image={getImage(props.localImages[0])} />
...
- While Unarmed
<iframe src="https://www.youtube.com/embed/ANRftv35JLg" width="100%" height="300px" frameborder="0"> </iframe> 

- While Armed with a One-Handed Weapon
<iframe src="https://www.youtube.com/embed/aOBET37kOE4" width="100%" height="300px" frameborder="0"> </iframe> 

- While Armed with a Two-Handed Weapon (Bug: Character rises above the ground. Will be patched soon.)
<iframe src="https://www.youtube.com/embed/CrWMZnb89TQ" width="100%" height="300px" frameborder="0"> </iframe> 
