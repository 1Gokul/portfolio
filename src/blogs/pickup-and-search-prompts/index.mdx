...
<GatsbyImage alt="ItemInteractPrompt.jpg" image={getImage(props.localImages[0])} />

If overlapping with a Container, the Search prompt will appear prompting the Player to search the Container.

<GatsbyImage alt="SearchPrompt.jpg" image={getImage(props.localImages[1])} />
...
<iframe src="https://blueprintue.com/render/s06cjcma" width="100%" height="400px" scrolling="no" allowfullscreen></iframe>
...
*(Move the mouse while holding the Right Mouse Button down to see the entire Blueprint.)*
<iframe src="https://blueprintue.com/render/zozqtwx9" width="100%" height="400px" scrolling="no" allowfullscreen> </iframe>

## In Action 

- ItemInteract Prompt
<iframe src="https://www.youtube.com/embed/3ONy3fMEnmE" width="100%" height="300px" frameborder="0"> </iframe> 

- Search Prompt
<iframe src="https://www.youtube.com/embed/s4wPKBajsEo" width="100%" height="300px" frameborder="0"> </iframe> 
